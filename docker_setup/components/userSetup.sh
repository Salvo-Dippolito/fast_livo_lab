...
#plugdev added to acces usb3 camera set up by mvs in the container?
...
PS1="\[\033[01;33m\]\u\[\e[38;5;198m\]@\${CONTAINER_NAME:-FAST_LIVO} \W \$(parse_git_branch)\$\[\e[0;97m\] "
...
source /home/${username}/ros_ws/devel/local_setup.bash
...
export LD_LIBRARY_PATH=/home/percro_drone/ros_ws/devel/lib:/opt/ros/noetic/lib:/usr/lib:/usr/local/lib:/usr/lib/x86_64-linux-gnu:/usr/local/nvidia/lib:/usr/local/nvidia/lib64:/opt/MVS/bin
alias source_cam="export LD_LIBRARY_PATH=/opt/MVS/lib/64:/opt/MVS/bin:/home/percro_drone/ros_ws/devel/lib:/opt/ros/noetic/lib:/usr/lib:/usr/local/lib:/usr/lib/x86_64-linux-gnu:/usr/local/nvidia/lib:/usr/local/nvidia/lib64"
alias source_ros="export LD_LIBRARY_PATH=/home/percro_drone/ros_ws/devel/lib:/opt/ros/noetic/lib:/usr/lib:/usr/local/lib:/usr/lib/x86_64-linux-gnu:/usr/local/nvidia/lib:/usr/local/nvidia/lib64"
alias chp="echo \$LD_LIBRARY_PATH"
alias gbash="gedit /home/percro_drone/.bashrc"
alias rst_fl="export START_TMUX=0"
