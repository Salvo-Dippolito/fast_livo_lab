...
cname="fast_livo2_pp" #shows up in the image tag , name of the container that runs from the image we're creating
build_options=""
create_options=""
# modules=""
modules="openCV,pcl,sophus,livoxSDK,ros_setup" # maybe add opencv and other modules here as a list, each of these need a specific .sh script
  #       drivers,     # with necessary installation steps to be placed in the components directory, they get called by the Dockerfile
